               ...
               // Toast.makeText(getApplicationContext(), "bello", Toast.LENGTH_LONG).show();
                ...
                switch(output){
                    case 1:
                        ...
                        break;
                    case 2:
                        Snackbar.make(findViewById(android.R.id.content), "Money taken from GoCredit Balance", Snackbar.LENGTH_INDEFINITE)
                        ...
                        break;
                    case 3:
                        Snackbar.make(findViewById(android.R.id.content), "You do not have enough Gocredits left", Snackbar.LENGTH_INDEFINITE)
                                .setAction("Ok", snackaction)
                                .setActionTextColor(Color.WHITE)
                                .show();
                }
